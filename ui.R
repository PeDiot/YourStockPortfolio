                        ...
                        mainPanel( 
                          tabsetPanel(
                            ...
                            tabPanel("Candlestick",
                                     br(), 
                                     h4(strong("Candlestick & Moving Averages"), 
                                        align = "center", 
                                        style = "color:#76787B;"),
                                     br(), 
                            ...
                            tabPanel("Volatily",
                                     br(), 
                                     h4(strong("Prices & Bollinger Bands"), 
                                        align = "center", 
                                        style = "color:#76787B;"),
                                     br(),
                            ...
                            tabPanel("MACD",
                                     br(), 
                                     h4(strong("Prices & Moving Average Convergence Divergence (MACD)"), 
                                        align = "center", 
                                        style = "color:#76787B;"),
                                     br(), 
                            ...
                            tabPanel("RSI",
                                     br(), 
                                     h4(strong("Prices & Relative Strength Index (RSI)"), 
                                        align = "center", 
                                        style = "color:#76787B;"),
                                     br(), 
                            ...
                            tabPanel("OBV",
                                     br(), 
                                     h4(strong("Prices, Volume & On-Balance Volume (OBV)"), 
                                        align = "center", 
                                        style = "color:#76787B;"),
                                     br(), 
